...
%UPV
\cventry{2016 -- *}{Tècnic d'investigació i Desenvolupador de Software}{Universitat Politècnica de València}{Alcoi}{}{Desenvolupament de tasques d'investigació al projecte \href{http://www.inaer.com/es/areaIndustrial/ficha?idp=10}{ontime}}
...
%ITI
\cventry{2009}{Técnico de Investigación y Desarrollo de Software}{Instituto Tecnológico de Informática}{Alcoi}{}{Responsable del desenvolupament i el disseny del projecte VirtualCar per a la visualització d'automòbils modelitzats per computador}
