...
%Everis
\cventry{2015--2016}{Analista de Software Sènior en Mobilitat}{Everis Centers, S.L.}{Alacant}{}{Desenvolupament, disseny i implementació de solucions per a la plataforma mòbil iOS. Formació dels companys en les tecnologies utilitzades\newline{}\newline{}
Tasques desenvolupades:
\begin{itemize}
	\item \textbf{Git:} Concepció de l'estratègia per a combinar els diversos desenvolupaments de l'equip amb submoduls i diverses rames
	...
	\item \textbf{SonarQube:} Instal·lació i configuració d'aquesta ferramenta per a obtenir mes tipus d'analis esttatic de codi.
\end{itemize}
}
...
Desenvolupament de tasques d'investigació en el projectes d'investigació TacTic i Prometeo. Investigació i desenvolupament d'algoritmes per a renderitzar informació vectorial en entorns 3D i 2D i fer-la accessible en temps real. Desenvolupament d'aplicacions per a demostrar el seu funcionament. \newline{}\newline{} 
...
%ITI
\cventry{2009}{Tècnic d'investigació i Desenvolupador de Software}{Institut Tecnològic d'Informàtica}{Alcoi}{}{Responsable del desenvolupament i el disseny del projecte VirtualCar per a la visualització d'automòbils modelitzats per computador \newline{}\newline{}
Tasques Desenvolupades:
\begin{itemize}
...
%Cámara
\cventry{2006--2008}{Responsable d'Informàtica}{Cambra Oficial de Comerç i Industria d'Alcoi}{Alcoi}{}{Gestió de la xarxa interna, de les bases de dades i manteniment de la Web\newline{}\newline{}
Tasques Desenvolupades
\begin{itemize}
...
\cvcomputer{Bases de Dades}{MongoDB, MySQL,PostgreSQL, SQLite, JavaDB,couchdb}{Ferramentes de Treball en grup}{trac, JIRA, subversion, git (git-flow), SourceTree, Perforce}
