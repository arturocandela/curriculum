...
\section{Informática}
\cvcomputer{Llenguatjes de Programació}{Objective-C, python, Java, JavaScript, C, C++, C\#}{Plataformas Móviles}{Android, iOS (iPhone e iPad)}
\cvcomputer{Bases de Datos}{MongoDB, MySQL,PostgreSQL, PorgreSQL, SQLite, JavaDB,couchdb}{Ferramentes de Treball en grup}{trac, JIRA, subversion, git (git-flow), SourceTree, Perforce}
